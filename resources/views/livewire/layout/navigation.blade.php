            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @can('admin.users.edit')
                        <x-nav-link :href="route('admin.users.index')" :active="request()->routeIs('admin.users.index', 'admin.users.edit')" wire:navigate>
                            Usuarios
                        </x-nav-link>
                    @endcan

                    <x-nav-link :href="route('support')" :active="request()->routeIs('support')" wire:navigate>
                        {{ __('Support') }}
                    </x-nav-link>
                    {{-- ---------------------------------- --}}
                </div>
