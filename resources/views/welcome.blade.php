        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
                    ...
                    <div
                        ...
                        <div>
                            <div
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" stroke-width="2" fill="none"
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Proyecto Sistema de
                                gestion de
                                vacaciones</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Esta aplicacion fue realizada y desarrollada por el equipo conformado por:
                            </p>
            ...
            <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
                <div class="ml-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0">
                    Este sitio fue echo con Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP
                    v{{ PHP_VERSION }})
                </div>
            </div>
        </div>
