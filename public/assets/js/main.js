...
//         if (data[dis_column_hide] == "False") {
//             row.style.backgroundColor = "lightgoldenrodyellow";
//         }
//     },
//     responsive: true,
//     dom: "<'row'<'col-sm col-md'l><'col-sm col-md' B><'col-sm col-md'f>>" + "<'row'<'col-sm-12'tr>>" + "<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>",
//     fixedHeader: false,
//     order: [[2, 'desc']],
//     columnDefs: [{
//         searchPanes: {
...
//             show: false
//         },
//         targets: [dis_previous_column, dis_column_hide, dis_column_hide + 1]
//     }, {
//         targets: [dis_column_hide, dis_column_hide + 1],
//         visible: false,
//         searchable: true,
//         className: 'noVis'
//     }
