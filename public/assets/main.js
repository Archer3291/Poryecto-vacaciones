$(document).ready(function () {
    $("#miTabla").DataTable({
        language: {
            "lengthMenu": "<p class='text-gray-900 dark:text-white'> mostrar _MENU_ registros</p>",
            "sSearch": "<p class='text-gray-900 dark:text-white flex'> Buscar:",
            "zeroRecords": "<p class='text-gray-900 dark:text-white dark:bg-gray-900'> No se encontraron resultados </p>",
            "info": "<p class='text-gray-900 dark:text-white'> Mostrando registros del _START_ al _END_ de un total de _TOTAL_ registros </p>",
            "infoEmpty": "<p class='text-gray-900 dark:text-white'> Mostrando registros del 0 al 0 de un total de 0 registros </p>",
            "infoFiltered": "<p class='text-gray-900 dark:text-white'> (filtrado de un total de _MAX_ registros) </p>",
            "oPaginate": {
                "sNext": "<p class='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded'> Siguiente </p>",
                "sPrevious": "<p class='text-gray-900 dark:text-white'> Anterior </p>"
            },
            "sProcessing": "<p class='text-gray-900 dark:text-white'> Procesando... </p>",
        },
        responsive: "true",
        dom: 'Blfrtip',
        buttons: [
